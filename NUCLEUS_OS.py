...
# Set to True when Ctrl+C should return all the way to the NUCLEUS OS main menu.
...
def automatic_radiation_monitoring(conn):
    ...
    print("\nPress Ctrl+C to close the live display and return to the NUCLEUS OS main menu.")
    ...
    try:
        ...
        print("Returning to the NUCLEUS OS main menu...")
    except Error as e:
...
def radiation_monitoring_module(conn):
    ...
    while True:
        ...
        if choice == "1":
            ...
            automatic_radiation_monitoring(conn)
...
def dashboard(conn, username, role):
    ...
    while True:
        ...
        # Ctrl+C from live automatic monitoring returns to the NUCLEUS OS
        # main menu while the background monitoring thread keeps running.
        if RETURN_TO_MAIN_MENU:
            RETURN_TO_MAIN_MENU = False
            print("\nReturning to the NUCLEUS OS main menu...")
            return
...
def main():
    ...
    print("  One alert is generated at cycle 10, then 30, 50, 70, ...")
